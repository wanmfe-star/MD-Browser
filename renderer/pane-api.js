(() => {
  ...
  previewEl.addEventListener('click',event=>{if(event.target.closest('#emptyOpenBrowser'))window.browserPane.show();});
  window.paneClient={
    id, state,
    layoutBrowser:()=>window.browserPane.layout(),
    openBrowser:()=>window.browserPane.show(),
